		...
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					PricingTier = table.Column<byte>(type: "smallint", maxLength: 20, nullable: false, defaultValue: (byte)0),
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					Active = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
					CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
					AlertSubscriptionId = table.Column<string>(type: "text", nullable: true)
				},
				constraints: table =>
				{
			...
			migrationBuilder.CreateIndex(
				name: "IX_ScheduleSlots_SuburbId_Stage_DayOfWeek_StartTime",
				schema: "dbo",
				table: "ScheduleSlots",
				columns: new[] { "SuburbId", "Stage", "DayOfWeek", "StartTime" },
				unique: true);
